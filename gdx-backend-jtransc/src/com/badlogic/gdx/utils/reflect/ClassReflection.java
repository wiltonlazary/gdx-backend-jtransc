...
public final class ClassReflection {
	...
	static public Class forName (String name) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.forName(" + name + ")", e);
		}
	}
	...
	static public <T> T newInstance (Class<T> c) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.newInstance(" + c.getName() + ")", e);
		}
	}
	...
	static public Constructor getConstructor (Class c, Class... parameterTypes) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.getConstructor(" + c.getName() + ")", e);
		}
	}
	...
	static public Constructor getDeclaredConstructor (Class c, Class... parameterTypes) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.getDeclaredConstructor(" + c.getName() + ")", e);
		} 
	}
	...
	static public Method getMethod (Class c, String name, Class... parameterTypes) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.getMethod(" + c.getName() + ", " + name + ")", e);
		}
	}
	...
	static public Method getDeclaredMethod (Class c, String name, Class... parameterTypes) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.getDeclaredMethod(" + c.getName() + ", " + name + ")", e);
		}
	}
	...
	static public Field getField (Class c, String name) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.getField(" + c.getName() + ", " + name + ")", e);
		}
	}
	...
	static public Field getDeclaredField (Class c, String name) throws ReflectionException {
		try {
			...
			e.printStackTrace();
			throw new ReflectionException("ClassReflection.getDeclaredField(" + c.getName() + ", " + name + ")", e);
		}
	}
